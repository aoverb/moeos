...
![启动界面](.\screenshots\boot.jpg)

#### 管道与文件操作演示

![管道与文件操作演示](.\screenshots\echo-pipe-ll-kilo-cat.gif)

#### Telnet、进程列表、通过信号杀死进程

![网络与信号](.\screenshots\telnet-ps-signal-kill.gif)

#### ProcFS与PS演示

![ProcFS与PS演示](.\screenshots\ps-procfs.gif)

#### netstat演示

![netstat演示](.\screenshots\netstat.gif)
